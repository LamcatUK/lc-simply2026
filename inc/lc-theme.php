...
add_filter(
	...
	function ( $items, $args ) {
		if ( 'primary_nav' === $args->theme_location ) {
			$items .= '<li class="nav-item nav-item--cta d-none d-sm-block"><a class="nav-link" href="tel:' . parse_phone( get_field( 'contact_phone', 'option' ) ) . '"><i class="bi bi-telephone-fill me-2"></i>' . esc_html( get_field( 'contact_phone', 'option' ) ) . '</a></li>';
			$items .= '<li class="nav-item nav-item--cta"><a class="button button--lg" href="/contact/">Contact Us</a></li>';
			$items .= '<li class="nav-item nav-item--cta d-sm-none"><a class="button button--lg" href="tel:' . parse_phone( get_field( 'contact_phone', 'option' ) ) . '"><i class="bi bi-telephone-fill me-2"></i> Call Now</a></li>';
			...
			$items .= '<li class="nav-item nav-item--cta d-sm-none"><a class="button button--lg" href="mailto:' . antispambot( get_field( 'contact_email', 'option' ) ) . '"><i class="bi bi-envelope-fill me-2"></i> Email Us</a></li>';
